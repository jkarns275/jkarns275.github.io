...
var xyz_d50 = ColorSpace.create({
	id: "xyz-d50",
	name: "XYZ D50",
	white: "D50",
	base: XYZ,
	fromBase: coords => adapt$1(XYZ.white, "D50", coords),
	toBase: coords => adapt$1("D50", XYZ.white, coords),
	formats: {
		functions: {
			color: {}
		}
...
function serialize (color, {
	...
	if (inGamut$1 && !inGamut(color)) {
		coords = toGamut(color, inGamut$1 === true? undefined : inGamut$1).coords;
	}
...
function getLuminance(color) {
	return get(color, [XYZ, "y"]);
}

function setLuminance(color) {
	set(color, [XYZ, "y"], value);
}
...
var XYZ_Abs_D65 = ColorSpace.create({
...
var sRGBLinear = RGBColorSpace.create({
	id: "srgb-linear",
	name: "Linear sRGB",
	white: "D65",
	toXYZ_M: toXYZ_M$5,
...
var P3Linear = RGBColorSpace.create({
	id: "p3-linear",
	name: "Linear P3",
	white: "D65",
	toXYZ_M: toXYZ_M$4,
...
var A98Linear = RGBColorSpace.create({
	id: "a98rgb-linear",
...
var ProPhotoLinear = RGBColorSpace.create({
	id: "prophoto-linear",
...
var REC2020Linear = RGBColorSpace.create({
	id: "rec2020-linear",
...
var ACEScg = RGBColorSpace.create({
	id: "acescg",
	name: "ACEScg",
